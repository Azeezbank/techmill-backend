...
router.get("/", RoleGuard.admin, async (_req, res) => {
    try {
...
// BAN user
router.patch("/ban/:id", RoleGuard.admin, async (req, res) => {
    try {
...
// UNBAN user
router.patch("/unban/:id", RoleGuard.admin, async (req, res) => {
    try {
...
router.patch("/make/admin/:id", AuthGuard.authenticate, async (req, res) => {
    try {
