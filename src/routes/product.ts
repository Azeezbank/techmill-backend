...
// Create product
router.post("/", AuthGuard.authenticate, async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
// Update product
router.put("/:id", AuthGuard.authenticate, async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
// Delete product
router.delete("/:id", AuthGuard.authenticate, async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
// Get user products
router.get("/my-products", AuthGuard.authenticate, async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.put("/:id/approve", AuthGuard.authenticate, RoleGuard.admin, async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
...
router.put("/:id/reject", AuthGuard.authenticate, RoleGuard.admin, async (req: AuthRequest, res: Response, next: NextFunction) => {
  try {
